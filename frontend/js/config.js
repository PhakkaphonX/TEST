...
const CONFIG = {
    ...
    // Vision API Settings (High Accuracy Mode)
    // Set to false to use local Teachable Machine model (offline, faster)
    USE_VISION_API: false,
    VISION_API_KEY: 'YOUR_API_KEY_HERE',

    // AI Model Settings
    AI: {
        // For demo purposes, map MobileNet predictions to Thai foods
        THAI_FOOD_MAPPING: {
